...
# Creating the json to upload to the server.
# def json_to_upload_generator():
...
def list_images():
    ...
    sorted_dictionary = {key: val for key, val in sorted(image_name_list.items(), key=lambda element: element[1])}
...
if __name__ == "__main__":
    ...
    try:
        ...
        task_object_loop = event.create_task(async_task_handler(model, task_seconds=10))
